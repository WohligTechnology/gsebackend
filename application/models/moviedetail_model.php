...
{
public function create($isupcoming,$isreleased,$name,$banner,$imdb,$producer,$director,$cast,$music,$synopsis,$videos,$releasedate,$image,$hashtag,$facebook,$twitter,$instagram,$order,$status)
{
    $releasedate = new DateTime($releasedate);
        $releasedate = $releasedate->format('Y-m-d');
$data=array("isupcoming" => $isupcoming,"isreleased" => $isreleased,"name" => $name,"banner" => $banner,"imdb" => $imdb,"producer" => $producer,"director" => $director,"cast" => $cast,"music" => $music,"synopsis" => $synopsis,"videos" => $videos,"releasedate" => $releasedate,"image" => $image,"hashtag" => $hashtag,"facebook" => $facebook,"twitter" => $twitter,"instagram" => $instagram,"order" => $order,"status" => $status);
...
public function edit($id,$isupcoming,$isreleased,$name,$banner,$imdb,$producer,$director,$cast,$music,$synopsis,$videos,$releasedate,$image,$hashtag,$facebook,$twitter,$instagram,$order,$status)
{
