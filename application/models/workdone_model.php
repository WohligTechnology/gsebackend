...
{
    public function create($title,$date,$city,$description,$image,$url)
    {
        $data=array("title" => $title,"date" => $date,"city" => $city,"description" => $description,"image" => $image,"url" => $url);
    ...
    public function edit($id,$title,$date,$city,$description,$image,$url)
    {
        if($image=="")
        {
