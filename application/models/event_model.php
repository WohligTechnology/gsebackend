...
{
public function create($name,$image,$banner,$order)
{
$data=array("name" => $name,"image" => $image,"banner" => $banner,"order" => $order);
...
public function edit($id,$name,$image,$banner,$order)
{
if($image=="")
{
