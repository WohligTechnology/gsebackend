...
{
public function create($name,$image,$banner,$order,$hashtag,$facebook,$twitter,$instagram)
{
$data=array("name" => $name,"image" => $image,"banner" => $banner,"order" => $order,"hashtag" => $hashtag,"facebook" => $facebook,"twitter" => $twitter,"instagram" => $instagram);
...
public function edit($id,$name,$image,$banner,$order,$hashtag,$facebook,$twitter,$instagram)
{
if($image=="")
{
