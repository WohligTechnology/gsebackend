...
{
public function create($sportscategory,$name,$image,$link,$location,$content,$videos,$date,$banner)
{
        $date = new DateTime($date);
        $date = $date->format('Y-m-d');
$data=array("sportscategory" => $sportscategory,"name" => $name,"image" => $image,"link" => $link,"location" => $location,"content" => $content,"videos" => $videos,"date" => $date,"banner" => $banner);
...
public function edit($id,$sportscategory,$name,$image,$link,$location,$content,$videos,$date,$banner)
{
            $date = new DateTime($date);
        $date = $date->format('Y-m-d');
if($image=="")
