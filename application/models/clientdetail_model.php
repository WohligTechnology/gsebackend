...
{
public function create($order,$status,$name,$image,$title,$url,$content)
{
$data=array("order" => $order,"status" => $status,"name" => $name,"image" => $image,"title" => $title,"url" => $url,"content" => $content);
...
public function edit($id,$order,$status,$name,$image,$title,$url,$content)
{
if($image=="")
{
