<div class="row">
<div class="col s12">
<h4 class="pad-left-15 capitalize">Edit sports category</h4>
</div>
</div>
<div class="row">
<form class='col s12' method='post' action='<?php echo site_url("site/editsportscategorysubmit");?>' enctype= 'multipart/form-data'>
