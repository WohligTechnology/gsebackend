<div class="row">
<div class="col s12">
<h4 class="pad-left-15 capitalize">Create sports category</h4>
</div>
<form class='col s12' method='post' action='<?php echo site_url("site/createsportscategorysubmit");?>' enctype= 'multipart/form-data'>
<div class="row">
...
<div class="row">
			...
			<span style=" display: block;
		padding-top: 30px;">1800 X 427</span>
		</div>
<div class="row">
...
<a href="<?php echo site_url("site/viewsportscategory"); ?>" class="btn btn-secondary waves-effect waves-light red">Cancel</a>
</div>
</div>
</form>
</div>
