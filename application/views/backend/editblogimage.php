<div class="row">
<div class="col s12">
<h4 class="pad-left-15 capitalize">Edit blog image</h4>
</div>
</div>
<div class="row">
...
<a href='<?php echo site_url("site/viewblogimage?id=").$this->input->get('diaryarticleid'); ?>' class='btn btn-secondary waves-effect waves-light red'>Cancel</a>
</div>
</div>
</form>
</div>
