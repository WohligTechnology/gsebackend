...
<div class="row">
<form class='col s12' method='post' action='<?php echo site_url("site/editmicetypesubmit");?>' enctype= 'multipart/form-data'>
...
<a href='<?php echo site_url("site/viewmicetype?id=").$this->input->get('miceid'); ?>' class='btn btn-secondary waves-effect waves-light red'>Cancel</a>
</div>
</div>
</form>
</div>
