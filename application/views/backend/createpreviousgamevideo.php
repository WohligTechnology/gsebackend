...
<div class="row">
<form class='col s12' method='post' action='<?php echo site_url("site/createpreviousgamevideosubmit");?>' enctype= 'multipart/form-data'>
<div class="row">
...
<a href='<?php echo site_url("site/viewpreviousgamevideo?id=").$this->input->get('id'); ?>' class='btn btn-secondary waves-effect waves-light red'>Cancel</a>
</div>
</div>
</form>
</div>
